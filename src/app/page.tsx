...
function WhatIsJhana() {
  return (
    <Section
      title="What is Jhana meditation?"
      eyebrow="The practice"
      eyebrowTone="text-cobalt"
    >
      <p>
...
function TheMechanism() {
  return (
    ...
    >
      ...
      <p>
        The anchor itself isn&rsquo;t what you meditate on. What you attend to
        is the feeling it produces in your body: the warmth in the chest, the
...
function HowToPractise() {
  ...
  return (
    <Section
      title={<>How it&rsquo;s practised</>}
      eyebrow="Step by step"
      eyebrowTone="text-saffron-hover"
    >
      <p>
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <ul className="flex flex-col gap-1">
        {states.map((s) => (
          <li key={s.n} className="flex gap-4 py-2">
            <span
              aria-hidden="true"
...
function Collaborative() {
  return (
    <section className="flex flex-col gap-4 rounded-xl bg-cobalt px-7 py-8 text-white">
...
function PrimaryCta() {
  return (
    <Link
      href="/practice"
      className="breath btn-primary rounded-lg px-7 py-3.5 font-bold"
    >
      Try it for yourself
    </Link>
  );
...
function Section({
  ...
  /** Small coloured label above the heading, to give each section its own key. */
  eyebrow?: string;
  eyebrowTone?: string;
  ...
  return (
    <section className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        {eyebrow && (
          <p
            className={`text-xs font-semibold uppercase tracking-widest ${eyebrowTone}`}
          >
            {eyebrow}
          </p>
        )}
