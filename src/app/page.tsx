...
function HowToPractise() {
 ...
 <span
 aria-hidden="true"
 className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full font-semibold text-sm "
 >
 {i + 1}
 </span>
 <div className="flex flex-col gap-1">
 <p className="text-lg font-boldtext-ink">{step.title}</p>
