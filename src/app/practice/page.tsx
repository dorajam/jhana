...
export default async function SitPage() {
  ...
  return (
    <div className="flex flex-col items-center gap-2 pt-6">
      <p className="font-serif text-2xl text-ink">Let&rsquo;s begin.</p>
      <p className="max-w-sm text-center text-sm text-ink-soft">
        Set a length and settle in. When the bell fades, you&rsquo;ll log the
        sit while it&rsquo;s still fresh.
      </p>
      <SitTimer />
